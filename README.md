...
- [VictoriaLogs в Kubernetes: от установки до практического применения](#victorialogs-в-kubernetes-от-установки-до-практического-применения)
  ...
  - [Полное руководство по LogsQL](#полное-руководство-по-logsql)
    - [1. Фильтрация логов и временные фильтры](#1-фильтрация-логов-и-временные-фильтры)
    - [2. Быстрые примеры (nginx-log-generator)](#2-быстрые-примеры-nginx-log-generator)
    - [3. Примеры дашбордов / графиков](#3-примеры-дашбордов--графиков)
    - [4. LogsQL — язык запросов VictoriaLogs (кратко)](#4-logsql--язык-запросов-victorialogs-кратко)
    - [5. Операторы пайплайна (часто используемые)](#5-операторы-пайплайна-часто-используемые)
    - [6. Извлечение данных и парсинг](#6-извлечение-данных-и-парсинг)
    - [7. Агрегации и аналитика (stats)](#7-агрегации-и-аналитика-stats)
    - [8. Вычисления (math) и условия в агрегациях](#8-вычисления-math-и-условия-в-агрегациях)
    - [9. Практические паттерны](#9-практические-паттерны)
    - [10. Использование LogsQL в Grafana / VMUI](#10-использование-logsql-в-grafana--vmui)
    - [11. Cheatsheet (кратко)](#11-cheatsheet-кратко)
    - [12. Учебное пособие по LogsQL](#12-учебное-пособие-по-logsql)
    - [13. Советы по повышению производительности](#13-советы-по-повышению-производительности)
    - [14. Устранение неполадок (Troubleshooting)](#14-устранение-неполадок-troubleshooting)
    - [15. Справочник фильтров LogsQL](#15-справочник-фильтров-logsql)
...
## Причина высокой производительности

### Колоночное хранение каждого key

![Схема колонночного хранения](Схема колонночного хранения.png)
