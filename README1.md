...
Обновлённое и вычитанное руководство по развёртыванию и использованию VictoriaLogs в Kubernetes. Документ фокусируется на практических шагах: установка через Helm, интеграция с cert-manager и Ingress, генерация логов, базовые примеры запросов в LogsQL и интеграция с экосистемой наблюдаемости.
...
- [VictoriaLogs в Kubernetes: от установки до практического применения](#victorialogs-в-kubernetes-от-установки-до-практического-применения)
  ...
  - [Примеры запросов и паттерны](#примеры-запросов-и-паттерны)
  - [LogsQL: более важные операторы (синтаксис)](#logsql-более-важные-операторы-синтаксис)
...
Цель этого README — дать понятную, проверенную на практике инструкцию для развёртывания стека и базовой работы с LogsQL.
...
| Критерий | VictoriaLogs | Elasticsearch | Grafana Loki |
||:|:|:|
| Простота установки | ★★★★★ | ★★ | ★★★ |
...
## LogsQL: более важные операторы (синтаксис)
