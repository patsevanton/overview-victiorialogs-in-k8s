...
Функция конвейера статистики `avg(field1, ..., fieldN)` вычисляет среднее значение по всем указанным [полям логов](https://docs.victoriametrics.com/victorialogs/keyconcepts/#data-model).
