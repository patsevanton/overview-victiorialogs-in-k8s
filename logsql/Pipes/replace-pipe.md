...
**Совет по производительности:** рекомендуется использовать более конкретные `фильтры логов`, чтобы уменьшить число записей логов, передаваемых в `replace`. Подробнее см. в разделе `общие советы по производительности`.
