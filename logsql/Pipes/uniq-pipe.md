...
возвращает уникальные значения для указанных `полей логов`
по логам, возвращаемым `запросом` `<q>`.
...
Уникальные записи возвращаются в произвольном порядке. При необходимости их можно отсортировать с помощью пайпа ``sort``.
